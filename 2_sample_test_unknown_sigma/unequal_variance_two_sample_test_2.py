...
def accept_or_reject(alpha,zscore,dof) :
    if ((stats.t.ppf(alpha,dof)>zscore) | (stats.t.ppf((1-alpha),dof)<zscore)):
       return "reject Ho"
    else :
       return "Accept Ho"
...
print(accept_or_reject(alpha,zscore,dof) )
